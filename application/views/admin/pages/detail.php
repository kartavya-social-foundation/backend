                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        ...
                                        {
                                            foreach($content_data as $key)
                                            {?>
                                                <tr>
                                                    <td><center><?php echo $i;?></center></td>
                                                    <td><center><?php echo $key->title;?></center> </td>
                                                    <td><center><a href="<?php echo base_url('setting/edit/'.$key->id);?>" title="click here to edit"><span class="label label-sm label-purple"><i class="fa fa-pencil"></i></span></a></center></td> 
                                                </tr>
                                                  <?php $i++;
                                             } }
                                          else
