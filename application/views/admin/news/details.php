            ...
            <div class="col-md-12">
              <div class="portlet box green">
                <div class="portlet-title">
                  <div class="caption">News Details</div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align:center"><button type="button" class="btn green"> <?php echo $news_data->title;?> </button></td>
                        </tr>
                         <tr>
                          <th width="30%"> Image </th>
                           <td colspan="2" style="text-align:center">

                             <?php if(isset($news_image[0]->image)){?>
                            <br><img src="<?php echo base_url('uploads/news_image/'.$news_image[0]->image);?>" width="100px" height="100px">
                            <?php } else echo "<strong> - No image found!</strong>";?>
                            </td>
                        </tr>
                        <tr>
                          <th width="30%"> Description </th>
                          <td><p><?php echo strip_tags($news_data->description);?> </p></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
