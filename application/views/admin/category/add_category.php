            ...
            <form action="" id="form11" class="form-horizontal form-row-seperated" onsubmit="return myFunction()" method="post" enctype="multipart/form-data" data-parsley-validate=''>
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" placeholder="Category Name" name="category" class="form-control"  required/>
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo base_url()?>category/add_category"><button type="button" class="btn default">Cancel</button></a>
                        </div>
                    </div>
                </div>
            </form>
