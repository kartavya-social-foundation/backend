                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Unverified Users
                                    </div>
                                    <div class="actions">
                                            ...
                                            foreach($user_data as $key)
                                            {
                                              ...
                                              ?>
                                                ...
                                                <td><center><input type="checkbox" class="emp_checkbox" data-emp-id="<?php echo $key->user_id; ?>"></center></td>       
                                                    ...
                                                    <td><center> <a class="btn1<?php echo $key->user_id;?>" onclick='deletemain("<?php echo $key->user_id;?>");' href="javascript:void(0);" title="click here to reject"><span class="label label-sm label-danger"><i class="fa fa-ban" aria-hidden="true"></i></span></a></center></td>
                                                </tr>
                                                  <?php  //$i++;
                                             } }
                                          else
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        ...
			        <div class="modal-body">
			          <form method="post" id ="form1" action="<?php echo base_url()?>user/user_reject">
