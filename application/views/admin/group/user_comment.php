                                            ...
                                            {?>
                                                <tr>
                                                    ...
                                                    <td width="60px;"><center>
                                                        <a onclick='deletemain("<?php echo substr($key['comment_id'],0,55).'...';?>");' href="javascript:void(0);" title="click here to delete"><span class="label label-sm label-danger"><i class="fa fa-trash-o"></i></span></a></center>
                                                    </td>
                                                </tr>
                                                  <?php  $i++;
                                             } }
...
function deletemain(id)
{
    ...
    {
        $.ajax({
           url:"<?php echo base_url('group/delete_user_comment')?>/"+id,
