                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    ...
                                    <a title="click here to delete" type="button" id="delete_records" class="btn green pull-right">Delete<i class="fa fa-toggle-on" aria-hidden="true"></i></a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        <thead>
                                           <tr>
                                                ...
                                                <th><center>Why Rejected</center></th>
                                            ...
                                            foreach($user_data as $key)
                                            {
                                              ...
                                              ?>
                                                ...
                                                <?php }else echo '';?>
                                                    ...
                                                    <td><center><?php echo $key->comment_for_rejection;?></center></td>
...
{ 
  var r = confirm('Are you really want to change status of this user?');
