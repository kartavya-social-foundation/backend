                    ...
                    <div class="tab-pane" id="tab_4">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                <i class="fa fa-gift"></i><small>Edit Organization</small> 
                                </div>
                                </div>
        ...
        <?php 
          ...
          ?>
           <?php if(!empty($organization)){ ?>
            <form  class="form-horizontal form-row-seperated" action="<?php echo base_url().'ambedkarite/edit_organization/'.$organization->organization_id?>" method="post" id="form11" data-parsley-validate=''>
                <div class="form-body">
                    <div class="form-group">
                        <label class="control-label col-md-3">Organization Name<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" placeholder="Organization Name" parsley-required="true" data-parsley-required-message="Organization Name field is required" name="Organization_name" class="form-control" value="<?php echo $organization->organization_name;?>" required/>
                        </div>
                    </div>
                    <div class="form-group">
                            <label class="control-label col-md-3">Organization Type<span class="required"> * </span></label>
                            <div class="col-md-7">
                                <input type="text" name="organization_type" placeholder="Organization Type" parsley-required="true" data-parsley-required-message="Organization Type field required"  
                            name="type" class="form-control" value="<?php echo $organization->organization_type;?>" required/>
                            </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Registration No.<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" placeholder="Registration No." parsley-required="true" data-parsley-required-message="Registration No. is required" value="<?php echo $organization->registration_no;?>" name="registration_no" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group" > 
                        <label class="control-label col-md-3">Founded On<span class="required"> * </span></label>
                        <div class="col-md-7">
                           <input type="name" name="fonded_on" placeholder="Founded on" value="<?php echo $organization->founded_on;?>" id="date1" data-parsley-required-message="Fonded on field is required" class="form-control" required >
                        </div>
                    </div>
                    <div class="form-group" > 
                        <label class="control-label col-md-3">Address<span class="required"> * </span></label>
                        <div class="col-md-7">
                           <input type="name" name="address" value="<?php echo $organization->location;?>" placeholder="Address" data-parsley-required-message="Address field is required" class="form-control" required>
                        </div>
                    </div>
                     <div class="form-group" > 
                        <label class="control-label col-md-3">City<span class="required"> * </span></label>
                        <div class="col-md-7">
                           <input type="name" name="city" value="<?php echo $organization->city;?>" placeholder="City" data-parsley-required-message="City is required" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Contributed By<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" name="contributed_by" value="<?php echo $organization->countributed_by;?>" placeholder="Contributed By" parsley-required="true" data-parsley-required-message="Contrybuted is required" name="link" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Activities<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" name="activities" value="<?php echo $organization->activities;?>" placeholder="Activities" parsley-required="true" data-parsley-required-message="Activities is required" name="link" class="form-control" required/>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-md-3">Leaders<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" name="leader" value="<?php echo $organization->leaders;?>" placeholder="Leaders" parsley-required="true" data-parsley-required-message="Leaders is required" name="link" class="form-control" required/>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-md-3">Contact Details<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <textarea class="form-control" parsley-required="true" data-parsley-required-message="contact Detail is required" name="contact_detail" rows="5" cols="15" name="" required><?php echo $organization->contact_details;?></textarea>
                        </div>
                    </div>
