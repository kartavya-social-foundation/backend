                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                       <a title="click here to delete" type="button" id="delete_records" class="btn blue pull-right">Delete<i class="fa fa-trash-o"></i></a>
                                        <a title="click here to active" type="button" id="active_records" class="btn blue pull-right">Active<i class="fa fa-trash-o"></i></a>
                                    </div>
                                </div>
                                            ...
                                            foreach($task_data as $key)
                                            {
                                                ...
                                                <tr id="xxx<?php echo $key->task_id;?>">
                                                    ...
                                                    <td><center>
                                                     ...
                                                     <td><center><a href="<?php echo base_url('task/detail/'.$key->task_id); ?>" title="click here to details"><span class="label label-sm label-primary"><i class="fa fa-info-circle"></i></span></a></center></td>
                                                </tr>
                                                  <?php  $i++;
                                             } }
                                          else
...
$.ajax({
type: "POST",
url: "<?php echo base_url('task/delete_grou')?>",
cache:false,
data: 'group_id='+selected_values,
