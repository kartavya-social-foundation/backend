                                    ...
                                    <div class="tab-pane" id="tab_4">
                                        <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                  <i class="fa fa-wrench"></i> Edit content</div>
                                            </div>
            ...
            <form action="" id="form11" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" data-parsley-validate=''  onSubmit="return myFunction()">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Title" name="title" class="form-control" value="<?php echo $content->title;?>" required/>
                             <?php echo form_error('title', "<span class='error'>", "</span>"); ?>
                        </div>
                    </div>
                    <?php if($content->id == 3){?> 
                     <div class="form-group">
                        <label class="control-label col-md-3">About us Image<span class="required"> * </span><br> <span> Size (1280*500 px)</span></label>
                        ...
                        <div class="col-md-7">
                            ...
                            <input type="file" name="image" id="inputfile"/>
                                ...
                                <?php
                                 ...
                                 {
                                    $image1 = base_url().'uploads/banner_image/'.$content->image;
                                 }else
                                 { 
                ...
                <?php }else { echo '';} ?>
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="ckeditor" name="description" id="noticemessage"><?php echo $content->description;?></textarea>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo base_url('setting/edit/'.$content->id)?>"><button type="button" class="btn default">Cancel</button></a>
                        </div>
                    </div>
                </div>
            </form>
