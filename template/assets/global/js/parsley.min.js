...
! function(e, t) {
    ...
    var c = function(e, t) {
        ...
        m = {
        	...
        	valid_username:/^(?=.*[0-9])(?=.*[a-zA-Z])([a-zA-Z0-9]+)$/,
        	valid_name:/^[\\p{L} .'-]+$/,
    ...
    E.prototype = {
        init: function(e) {
            return this.__class__ = "Parsley", this.__version__ = "2.3.5", this.__id__ = a.generateID(), this._resetOptions(e), this.$element.is("form") || a.checkAttr(this.$element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        },
        isMultiple: function() {
    ...
    }), /firefox/i.test(navigator.userAgent) && e(document).on("change", "select", function(t) {
    ...
    e.listen = function(e, n) {
        ...
        var n;
        R();
        var r = t instanceof x || t instanceof _,
    ...
    e.extend(!0, M, {
        ...
        validateString: function(t, i, n, r) {
            ...
            var d = M._remoteCache[a] = M._remoteCache[a] || e.ajax(s),
                h = function() {
        ...
        type: {
        	valid_password: "Password length should have minimun 8 and atleast 1 character,1 digit and special character.",
        	valid_username: "Username should be alfanumeric.",
        	valid_gender: "Please Select Gender.",
        	valid_name: "Alphabets and spaces allowed.",
