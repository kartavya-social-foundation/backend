                            ...
                            <div class="portlet light "style="border: 1px solid #84b4ad">
                                <div class="portlet-title">
                                    <div class="caption col-md-12">
                                        ...
                                        <div class="col-md-6">
                                        <form class="pull-right" method="post" action="<?php echo base_url().'analytics/other_filter';?>" onsubmit="return check_value()">
...
var chart = AmCharts.makeChart("chartdiv", {
  ...
  <?php 
    ...
    $blood_group = array(0 => "A+", 1 => "A-", 2 => "B+", 3 => "B-", 4 => "O+", 5 => "O-", 6 => "AB+", 7 => "AB-");
    // print_r($blood_group); 
    for ($i=0; $i < 8 ; $i++) { 
        $d = $blood_group[$i];
        $color = '#990000';
        ...
        if(isset($blood_group_count[$i]))
        {  
            ?>{ 
            "date": "<?php echo $d;?>",
            "visits":"<?php echo $blood_group_count[$i];?>",
