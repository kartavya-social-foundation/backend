...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title> Budhavihar|Details</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                       Budhavihar List</div>
                                        <a href="<?php echo base_url('ambedkarite/add_budhavihar');?>" title="click here to Unverified" type="button" id="reject_records" class="btn green pull-right">Add Budhavihar<i class="fa fa-plus" aria-hidden="true"></i></a>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        <thead>
                                           <tr>
                                                <th><center>Budhavihar Name</center></th>
                                                <th><center>Budhavihar Type</center></th>
                                        ...
                                        <?php 
                                        $i=1;
                                        if(!empty($buddhavihar))
                                        {
                                            foreach($buddhavihar as $key)
                                            {?>
                                                <tr id="xxx<?php echo $key->budhavihar_id;?>">
                                                    <td><center><?php echo $key->budhavihar_name; ?>
                                                        <span class="label label-sm label-success badge"><?php echo 'Registration No - '. $key->registration_no;?></span>    

                                                    </center> </td>
                                                    <td><?php echo $key->budhavihar_type;?> <br>
                                                    ...
                                                    <td><center><a href="<?php echo base_url('ambedkarite/edit_budhavihar/'.$key->budhavihar_id);?>" title="click here to edit"><span class="label label-sm label-purple"><i class="fa fa-pencil"></i></span></a></center></td>
                                                </tr>
                                                  <?php  $i++;
                                             } }
                                          else
