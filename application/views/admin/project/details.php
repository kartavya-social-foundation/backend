                    ...
                    <table class="table table-striped table-bordered table-hover">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align:center"><button type="button" class="btn green"> <?php echo $project_data->title;?> </button></td>
                        </tr>
                         <tr>
                           ...
                           <td colspan="2" style="text-align:center">
                            <?php if($project_image){
                              foreach ($project_image as $image) {?>
                                <img src="<?php echo base_url('uploads/project_image/'.$image->image);?>" height="100px" width="100px">&nbsp;&nbsp;&nbsp
                             <?php } 
                              } else echo "<strong> - No image found!</strong>";?>
                            </td>
                        </tr>
                        <tr>
                          <th width="30%"> Description </th>
                          <td><p><?php echo strip_tags($project_data->description);?> </p></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
