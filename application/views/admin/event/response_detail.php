                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-server"></i>Event Response </div>
                                    <div class="actions">
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        <thead>
                                           <tr>
                                                ...
                                                <th><center>Intrested</center></th>
                                                <th><center>May be</center></th>
                                                <th><center>Not Intrested</center></th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                           <tr>
                                       ...
                                       $i=1;
                                        ...
                                        { print_r($response_count);exit;?>
                                                <tr>
                                                    <td><center><?php echo $i;?></center> </td>
                                                    <td><center> <?php echo $key->event_title;?></center></td>
                                                    <td><center><?php echo $key->going_count;?></center></td>
                                                    <td><center><?php echo $key->maybe_count;?></center></td>
                                                    <td><center><?php echo $key->not_going_count;?></center></td>
                                                </tr>
                                                  <?php  $i++;
                                             } 
                                          else
