            ...
            <form action="" id="form11" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" data-parsley-validate=''  onSubmit="return myFunction()">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Title" name="title" class="form-control" value="<?php echo $blog_data->title;?>" required/>
                             <?php echo form_error('title', "<span class='error'>", "</span>"); ?>
                        </div>
                    </div>
                      <div class="form-group">
                        <label class="control-label col-md-3">Blog Image<span class="required"> * </span><br><span> Size (Max 700*500 px, 500kb)</span></label>
                        <div class="col-md-7">
                            <input type="file" name="image" id="inputfile"/>
                                <?php
                                 if(!empty($blog_image->image))   
                                 {
                                    $image1 = base_url().'uploads/blog_image/'.$blog_image->image;
                                 }else
                                 { 
                                    $image1 = base_url().'uploads/blog_image/image-not-found.gif';
                                 }  
                        ...
                        <span id="file411" style="color:red;margin-left:230px;list-style-type: none;font-size: 0.9em;line-height: 0.9em;""></span>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-md-3">Description<span class="required"> * </span></label>
                        <div class="col-md-9">
                            <textarea class="ckeditor" name="description" id="noticemessage"><?php echo $blog_data->description;?></textarea>
