                                    ...
                                    <div class="tab-pane" id="tab_4">
                                        <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Add News</div>
                ...
                <div class="form-body">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                             ...
                             <?php echo form_error('news_language', "<span class='error'>", "</span>");?>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                             ...
                             <?php echo form_error('news_type', "<span class='error'>", "</span>"); ?>
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">News URL</label>
                         <div class="col-md-9">
                        <input type="text" placeholder="News URL" name="news_url" data-parsley-type="url" class="form-control"/>
                             <?php echo form_error('news_url', "<span class='error'>", "</span>"); ?>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo base_url()?>news/add_news"><button type="button" class="btn default">Reset</button></a>
                        </div>
                    </div>
                </div>
            </form>
