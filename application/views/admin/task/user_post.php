                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><center>Post image</center></th>
                                        ...
                                        { 
                                            ...
                                            {?>
                                                 <tr id="xxx<?php echo $key['post_id'];?>">
                                                    ...
                                                    <!-- <td><center><a href="<?php //echo base_url('task/user_comment/'.$key['post_id']);?>" title="click here to detail"><span class="label label-sm label-purple">Comments</span></a></center></td>-->
...
$.ajax({
type: "POST",
url: "<?php echo base_url('task/delete_post')?>",
cache:false,
