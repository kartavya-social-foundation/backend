            ...
            <div class="col-md-12">
              <div class="portlet box green">
                <div class="portlet-title">
                  <div class="caption">Group Details</div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align:center"><button type="button" class="btn green"> <?php echo $group_data->title;?> </button></td>
                        </tr>
                         <tr>
                          <th width="30%"> Image </th>
                           <td colspan="2" style="text-align:center"> 
                            <?php if($group_data->image!=''){?>
                            <br><img src="<?php echo base_url('uploads/group_image/'.$group_data->image);?>" width="120px" hieght="120px">
                            <?php } else echo "<strong> - No image found!</strong>";?>
                            </td>
                        </tr>
                        <tr>
                          <th width="30%"> Description </th>
                          <td><p><?php echo strip_tags($group_data->description);?> </p></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
