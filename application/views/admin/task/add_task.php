                                    ...
                                    <div class="tab-pane" id="tab_4">
                                        <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Add Task</div>
                ...
                <div class="form-body">
                   <div class="form-group">
                    ...
                    <div class="form-group" > 
                        ...
                        <div class="col-md-3">
                           <input type="name" name="end_date" id="date2" readonly="readonly"  data-parsley-required-message="End date is required" class="form-control" required>
                        </div>
                    </div>
                    
                   <!--   <div class="form-group">
                        <label class="control-label col-md-3">Organised By<span class="required"> * </span></label>
                        <div class="col-md-9">
                            <input type="text" placeholder="Organised By" name="organised_by" class="form-control"  required/>
                             <?php //echo form_error('organised_by', "<span class='error'>", "</span>"); ?>
                        </div>
                    </div> -->
                    <div class="form-group">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <input type="submit" class="btn green" value="Submit" id="register">
                            <a href="<?php echo base_url()?>task/add_task"><button type="button" class="btn default">Reset</button></a>
                        </div>
                    </div>
                </div>
            </form>
