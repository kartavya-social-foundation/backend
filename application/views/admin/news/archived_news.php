                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-server"></i>Archive News</div>
                                    <div class="actions">
                                        ...
                                        if(!empty($news_data))
                                        {
                                            foreach($news_data as $key)
                                            {
                                                ...
                                                <tr id="xxx<?php echo $key->news_id;?>">
                                                    <td><center><input type="checkbox" class="emp_checkbox" data-news-id="<?php echo $key->news_id;?>"></center></td>
                                                    <td><center>
                                                    ...
                                                    <td>
                                                    <center><a href="<?php echo base_url('news/detail/'.$key->news_id) ?>" title="click here to details"><span class="label label-sm label-primary"><i class="fa fa-info-circle"></i></span></a></center>
                                                    </td>
                                                </tr>
                                                  <?php  $i++;
                                             } }
...
$.ajax({
type: "POST",
url: "<?php echo base_url('news/active_news1')?>",
cache:false,
...
if(news.length <=0) { alert("Please select records."); } else { WRN_PROFILE_DELETE = "Are you sure you want to delete "+(news.length>1?"these":"this")+" row?";
var checked = confirm(WRN_PROFILE_DELETE);
if(checked == true) {
var selected_values = news.join(",");
$.ajax({
