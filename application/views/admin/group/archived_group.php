                                        ...
                                        if(!empty($group_data))
                                        {
                                            foreach($group_data as $key)
                                            {
                                                ...
                                                <tr id="xxx<?php echo $key->group_id;?>">
                                                    ...
                                                    <td><center><?php echo substr($key->description,0,50)."...";?></td>
                                                    <td><center><a href="<?php echo base_url('group/detail/'.$key->group_id); ?>" title="click here to details"><span class="label label-sm label-primary"><i class="fa fa-info-circle"></i></span></a></center></td>
                                                </tr>
                                                  <?php $i++;
                                             } }
                                          else
...
<script type="text/javascript">
        ...
        // { 
        //     var str = "group_id="+id+"&status="+status;
