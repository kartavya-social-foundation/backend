    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
       ...
       <?php $this->load->view('admin/new_header'); ?>
                    ...
                    <div class="tab-pane" id="tab_4">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                <i class="fa fa-gift"></i><small>Add Budhavihar</small> 
                                </div>
                                </div>
        ...
        <?php 
          ...
          ?>
            <form  class="form-horizontal form-row-seperated" action="<?php echo base_url().'ambedkarite/add_budhavihar'?>" method="post"  id="form11" data-parsley-validate=''>
                <div class="form-body">
                    <div class="form-group">
                        <label class="control-label col-md-3">Budhavihar Name<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" placeholder="Budhavihar Name" parsley-required="true" data-parsley-required-message="Budhavihar Name field is required" name="budhavihar_name" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo base_url('ambedkarite/add_budhavihar');?>"><button type="button" class="btn default">Reset</button></a>
                        </div>
                    </div>
                </div>
            </form>
