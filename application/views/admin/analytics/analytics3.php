                                ...
                                <div class="portlet-title">
                                    <div class="caption col-md-12">
                                        <div class="col-md-6" style="margin:0.5em 0;">
                                          <span class="bold uppercase" style="color:#1B7310"><b>                            
                                            </b> </span>
                                        </div>
                                        <div class="col-md-6">
                                        <form class="pull-right" method="post" action="<?php echo base_url().'analytics/age_filter';?>" onsubmit="return check_value()">

                                         <select id="mon" name="month" class="btn btn-default btn-circle btn-outline">

                                            <option value="">Select</option>
                                            <option value="Jan"<?php if($month == 'Jan'){ echo 'selected';} ?>>January</option>
                                            <option value="Feb"<?php if($month == 'Feb'){ echo 'selected';} ?>>Febuary</option>
...
var chart = AmCharts.makeChart("chartdiv", {
  ...
  <?php 
    ...
    $blood_group = array(0 => "10-20", 1 => "20-30", 2 => "30-40", 3 => "40-50", 4 => "50-60", 5 => "60-70", 6 => "70-80", 7 => "80-90");
    // print_r($blood_group); 
    for ($i=0; $i < 8 ; $i++) { 
        $d = $blood_group[$i];
        $color = '#990000';
        ...
        if(isset($age_group_count[$i]))
        {  
            ?>{ 
            "date": "<?php echo $d;?>",
            "visits":"<?php echo $age_group_count[$i];?>",
