    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
       ...
       <?php $this->load->view('admin/new_header'); ?>
                    ...
                    <div class="tab-pane" id="tab_4">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                <i class="fa fa-gift"></i><small>Add Organization</small> 
                                </div>
                                </div>
        ...
        <div class="portlet-body form">
          ...
          ?>
            <form  class="form-horizontal form-row-seperated" action="<?php echo base_url().'ambedkarite/add_organization'?>" method="post"  id="form11" data-parsley-validate=''>
                <div class="form-body">
                    <div class="form-group">
                        <label class="control-label col-md-3">Organization Name<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" placeholder="Organization Name" parsley-required="true" data-parsley-required-message="Organization Name field is required" name="organization_name" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" placeholder="Registration No." parsley-required="true" data-parsley-required-message="Registration No. is required" name="registration_no" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group" > 
                        <label class="control-label col-md-3">Founded On<span class="required"> * </span></label>
                        <div class="col-md-7">
                           <input type="name" name="fonded_on" placeholder="Founded on" id="date1" data-parsley-required-message="Fonded on field is required" class="form-control" required >
                        </div>
                    </div>
                    <div class="form-group" > 
                        <label class="control-label col-md-3">Address<span class="required"> * </span></label>
                        <div class="col-md-7">
                           <input type="name" name="address" placeholder="Address" data-parsley-required-message="Address field is required" class="form-control" required>
                        </div>
                    </div>
                     <div class="form-group" > 
                        <label class="control-label col-md-3">City<span class="required"> * </span></label>
                        <div class="col-md-7">
                           <input type="name" name="city" placeholder="City" data-parsley-required-message="City is required" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Contributed By<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" name="contributed_by" placeholder="Contributed By" parsley-required="true" data-parsley-required-message="Contrybuted is required" name="link" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Activities<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" name="activities" placeholder="Activities" parsley-required="true" data-parsley-required-message="Activities is required" name="link" class="form-control" required/>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-md-3">Leaders<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <input type="text" name="leader" placeholder="Leaders" parsley-required="true" data-parsley-required-message="Leaders is required" name="link" class="form-control" required/>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-md-3">Contact Details<span class="required"> * </span></label>
                        <div class="col-md-7">
                            <textarea class="form-control" parsley-required="true" data-parsley-required-message="contact Detail is required" name="contact_detail" rows="5" cols="15" name="" required></textarea>
                        </div>
                    </div>
                   <!--  <div class="form-group" style="padding-left:25%">
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo base_url('ambedkarite/add_organization');?>"><button type="button" class="btn default">Reset</button></a>
                        </div>
                    </div>
                </div>
            </form>
