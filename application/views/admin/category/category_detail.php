                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                       Category Detail</div>
                                   <a href="<?php echo base_url()?>category/add_category"><button type="button" class="btn blue delete pull-right"><i class="fa fa-plus"></i><span> ADD CATEGORY</span></button></a>
                                </div>
                                            ...
                                            { ?>
                                                <tr>
                                                    ...
                                                    <td><center>
                                                     ...
                                                     <td>
                                                     <center>
                                                     <?php if(!empty($key['image'])){$image = $key['image'];}
                                                           else{ $image = 'image-not-found.gif';} ?> 
                                                        <img src="<?php echo base_url('uploads/category_image/'.$image); ?>" width="90px" height="80px">
                                                     </center></td>
                                                     <td width="85px;"><select class="form-control" onchange="changestatus(this.value,'<?php echo $key['category_id'];?>')" name="publish_status" style="width:108%;">
                                                    ...
                                                    <td width="60px;">
                                                      <center>
                                                        <a href="<?php echo base_url('category/edit/'.$key['category_id']); ?>" title="click here to edit"><span class="label label-sm label-purple"><i class="fa fa-pencil"></i></span></a></center>
                                                    </td>
                                                </tr>
                                                  <?php  $i++;
                                             } }
